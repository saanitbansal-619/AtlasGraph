...
Examples:
  ...
  atlas ingest commodity-prices --file data/raw/worldbank_pinksheet/CMO-Historical-Data-Monthly.xlsx --out data/processed/commodity_prices --source worldbank-pinksheet
